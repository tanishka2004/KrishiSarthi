...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-green-50 to-green-200 flex items-center justify-center px-4">
      <div className="max-w-2xl w-full bg-white/80 rounded-2xl shadow-lg p-8 text-center border border-green-200">
        ...
        <div className="mt-8 text-green-700 text-sm">
          &copy; {new Date().getFullYear()} KrishiSarthi. All rights reserved.
        </div>
      </div>
    </div>
  );
